...
{
  InProcessNode::InProcessNode(CryptoNote::ICore& core,
  ...
  InProcessNode::~InProcessNode() { doShutdown(); }
  ...
  bool InProcessNode::shutdown() { return doShutdown(); }
  ...
  void InProcessNode::workerFunc() { ioService.run(); }
                                   ...
                                   uint32_t& startHeight, const Callback& callback)
  {
    ...
    ioService.post(std::bind(&InProcessNode::getNewBlocksAsync, this, std::move(knownBlockIds),
      ...
      std::vector<CryptoNote::block_complete_entry>& newBlocks, uint32_t& startHeight)
  {
    ...
    try
    {
      ...
      std::vector<Crypto::Hash> supplement = core.findBlockchainSupplement(
          knownBlockIds, CryptoNote::COMMAND_RPC_GET_BLOCKS_FAST_MAX_COUNT, totalBlockCount,
          startHeight);
                                                      ...
                                                      const Callback& callback)
  {
    ...
    ioService.post(std::bind(&InProcessNode::getTransactionOutsGlobalIndicesAsync, this,
                             std::cref(transactionHash), std::ref(outsGlobalIndices), callback));
  }
  ...
  std::error_code InProcessNode::doGetTransactionOutsGlobalIndices(
      const Crypto::Hash& transactionHash, std::vector<uint32_t>& outsGlobalIndices)
  {
    {
      std::unique_lock<std::mutex> lock(mutex);
      if (state != INITIALIZED)
      ...
      const Callback& callback)
  {
    ...
    ioService.post(std::bind(&InProcessNode::getRandomOutsByAmountsAsync, this, std::move(amounts),
                             outsCount, std::ref(result), callback));
  }
                                       ...
                                       const Callback& callback)
  {
    ...
    ioService.post(std::bind(&InProcessNode::relayTransactionAsync, this, transaction, callback));
  }
  ...
  void InProcessNode::poolUpdated() { observerManager.notify(&INodeObserver::poolChanged); }
                                  ...
                                  const Callback& callback)
  {
    ...
    ioService.post(std::bind(&InProcessNode::queryBlocksLiteAsync, this, std::move(knownBlockIds),
                             timestamp, std::ref(newBlocks), std::ref(startHeight), callback));
  }
  ...
  {
    std::error_code ec =
        doQueryBlocksLite(std::move(knownBlockIds), timestamp, newBlocks, startHeight);
    callback(ec);
  }
      ...
      std::vector<Crypto::Hash>& deletedTxIds, const Callback& callback)
  {
    ...
    ioService.post([this, knownPoolTxIds, knownBlockId, &isBcActual, &newTxs, &deletedTxIds,
                    callback]() mutable {
      this->getPoolSymmetricDifferenceAsync(std::move(knownPoolTxIds), knownBlockId, isBcActual,
                                            newTxs, deletedTxIds, callback);
    });
  }
  ...
  void InProcessNode::getMultisignatureOutputByGlobalIndex(uint64_t amount, uint32_t gindex,
  ...
  void InProcessNode::getOutByMSigGIndexAsync(uint64_t amount, uint32_t gindex,
                                              MultisignatureOutput& out, const Callback& callback)
  {
    std::error_code ec = std::error_code();
                                ...
                                const Callback& callback)
  {
    ...
    ioService.post(std::bind(
        static_cast<void (InProcessNode::*)(const std::vector<uint32_t>&,
                                            std::vector<std::vector<BlockDetails>>&,
                                            const Callback&)>(&InProcessNode::getBlocksAsync),
        this, std::cref(blockHeights), std::ref(blocks), callback));
  }
                                     ...
                                     const Callback& callback)
  {
    std::error_code ec = core.executeLocked(
        std::bind(static_cast<std::error_code (InProcessNode::*)(
                      const std::vector<uint32_t>&, std::vector<std::vector<BlockDetails>>&)>(
                      &InProcessNode::doGetBlocks),
                  this, std::cref(blockHeights), std::ref(blocks)));
    callback(ec);
  }
  ...
  void InProcessNode::getBlocks(const std::vector<Crypto::Hash>& blockHashes,
                                std::vector<BlockDetails>& blocks, const Callback& callback)
  {
    std::unique_lock<std::mutex> lock(mutex);
    if (state != INITIALIZED)
    {
    ...
    ioService.post(
        std::bind(static_cast<void (InProcessNode::*)(const std::vector<Crypto::Hash>&,
                                                      std::vector<BlockDetails>&, const Callback&)>(
                      &InProcessNode::getBlocksAsync),
                  this, std::cref(blockHashes), std::ref(blocks), callback));
  }
  ...
  {
    std::error_code ec = core.executeLocked(
        std::bind(static_cast<std::error_code (InProcessNode::*)(const std::vector<Crypto::Hash>&,
                                                                 std::vector<BlockDetails>&)>(
                      &InProcessNode::doGetBlocks),
                  this, std::cref(blockHashes), std::ref(blocks)));
    callback(ec);
  }
  ...
  void InProcessNode::getBlocks(uint64_t timestampBegin, uint64_t timestampEnd,
                                uint32_t blocksNumberLimit, std::vector<BlockDetails>& blocks,
                                uint32_t& blocksNumberWithinTimestamps, const Callback& callback)
  {
    std::unique_lock<std::mutex> lock(mutex);
    if (state != INITIALIZED)
    {
    ...
    ioService.post(std::bind(
        static_cast<void (InProcessNode::*)(
            uint64_t, uint64_t, uint32_t, std::vector<BlockDetails>&, uint32_t&, const Callback&)>(
            &InProcessNode::getBlocksAsync),
        this, timestampBegin, timestampEnd, blocksNumberLimit, std::ref(blocks),
        std::ref(blocksNumberWithinTimestamps), callback));
  }

  void InProcessNode::getBlocksAsync(uint64_t timestampBegin, uint64_t timestampEnd,
                                     uint32_t blocksNumberLimit, std::vector<BlockDetails>& blocks,
                                     ...
                                     const Callback& callback)
  {
    std::error_code ec = core.executeLocked(
        std::bind(static_cast<std::error_code (InProcessNode::*)(
                      uint64_t, uint64_t, uint32_t, std::vector<BlockDetails>&, uint32_t&)>(
                      &InProcessNode::doGetBlocks),
                  this, timestampBegin, timestampEnd, blocksNumberLimit, std::ref(blocks),
  ...
  std::error_code InProcessNode::doGetBlocks(uint64_t timestampBegin, uint64_t timestampEnd,
                                             ...
                                             uint32_t& blocksNumberWithinTimestamps)
  {
    try
    {
      ...
      if (!core.getBlocksByTimestamp(timestampBegin, timestampEnd, blocksNumberLimit, rawBlocks,
                                      ...
                                      const Callback& callback)
  {
    ...
    ioService.post(std::bind(
        static_cast<void (InProcessNode::*)(const std::vector<Crypto::Hash>&,
                                            std::vector<TransactionDetails>&, const Callback&)>(
            &InProcessNode::getTransactionsAsync),
        this, std::cref(transactionHashes), std::ref(transactions), callback));
  }
                                           ...
                                           const Callback& callback)
  {
    std::error_code ec = core.executeLocked(
        std::bind(static_cast<std::error_code (InProcessNode::*)(const std::vector<Crypto::Hash>&,
                  ...
                  this, std::cref(transactionHashes), std::ref(transactions)));
    callback(ec);
  }

  std::error_code InProcessNode::doGetTransactions(
  ...
  void InProcessNode::getPoolTransactions(uint64_t timestampBegin, uint64_t timestampEnd,
                                          ...
                                          const Callback& callback)
  {
    ...
    ioService.post(std::bind(&InProcessNode::getPoolTransactionsAsync, this, timestampBegin,
                             timestampEnd, transactionsNumberLimit, std::ref(transactions),
                             std::ref(transactionsNumberWithinTimestamps), callback));
  }

  void InProcessNode::getPoolTransactionsAsync(uint64_t timestampBegin, uint64_t timestampEnd,
                                               uint32_t transactionsNumberLimit,
                                               std::vector<TransactionDetails>& transactions,
                                               uint64_t& transactionsNumberWithinTimestamps,
                                               const Callback& callback)
  {
    std::error_code ec =
        core.executeLocked(std::bind(&InProcessNode::doGetPoolTransactions, this, timestampBegin,
                                     timestampEnd, transactionsNumberLimit, std::ref(transactions),
  ...
  std::error_code InProcessNode::doGetPoolTransactions(
      uint64_t timestampBegin, uint64_t timestampEnd, uint32_t transactionsNumberLimit,
      std::vector<TransactionDetails>& transactions, uint64_t& transactionsNumberWithinTimestamps)
  {
    try
    {
      ...
      if (!core.getPoolTransactionsByTimestamp(timestampBegin, timestampEnd,
                                               transactionsNumberLimit, rawTransactions,
                                                 ...
                                                 const Callback& callback)
  {
    ...
    ioService.post(std::bind(&InProcessNode::getTransactionsByPaymentIdAsync, this,
                             std::cref(paymentId), std::ref(transactions), callback));
  }

  void InProcessNode::getTransactionsByPaymentIdAsync(const Crypto::Hash& paymentId,
                                                      std::vector<TransactionDetails>& transactions,
                                                      const Callback& callback)
  {
    std::error_code ec = core.executeLocked(std::bind(&InProcessNode::doGetTransactionsByPaymentId,
                                                      this, paymentId, std::ref(transactions)));

    callback(ec);
  }

  std::error_code InProcessNode::doGetTransactionsByPaymentId(
      const Crypto::Hash& paymentId, std::vector<TransactionDetails>& transactions)
  {
    try
    {
      std::vector<Transaction> rawTransactions;
  ...
  void InProcessNode::isSynchronized(bool& syncStatus, const Callback& callback)
  {
    ...
    ioService.post(
        std::bind(&InProcessNode::isSynchronizedAsync, this, std::ref(syncStatus), callback));
  }
