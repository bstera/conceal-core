...
namespace CryptoNote
{
  ...
  {
    size_t operator()(const TransactionOutputKey& outputId) const { return outputId.hash(); }
  };
  ...
  struct TransactionOutputInformationEx : public TransactionOutputInformationIn
  {
    ...
    TransactionOutputKey getTransactionOutputKey() const
    {
      return TransactionOutputKey{ transactionHash, outputInTransaction };
    }
  ...
  class TransfersContainer : public ITransfersContainer
  {
   public:
    ...
    void detach(uint32_t height, std::vector<Crypto::Hash>& deletedTransactions,
    ...
    virtual bool getTransactionInformation(const Crypto::Hash& transactionHash,
    ...
    virtual std::vector<TransactionOutputInformation> getTransactionOutputs(
        const Crypto::Hash& transactionHash, uint32_t flags) const override;
    ...
    virtual bool getTransfer(const Crypto::Hash& transactionHash, uint32_t outputInTransaction,
                             TransactionOutputInformation& transfer,
                             TransferState& transferState) const override;
   ...
   private:
    ...
    typedef boost::multi_index_container<
        ...
        boost::multi_index::indexed_by<
            ...
            boost::multi_index::hashed_unique<
                ...
                boost::multi_index::const_mem_fun<
                    TransactionOutputInformationEx, TransactionOutputKey,
    ...
    typedef boost::multi_index_container<
        ...
        boost::multi_index::indexed_by<
            ...
            boost::multi_index::hashed_non_unique<
                boost::multi_index::tag<ContainingTransactionIndex>,
                boost::multi_index::const_mem_fun<TransactionOutputInformationEx,
                                                  const Crypto::Hash&,
    ...
    typedef boost::multi_index_container<
        ...
        boost::multi_index::indexed_by<
            ...
            boost::multi_index::hashed_unique<boost::multi_index::tag<TransactionOutputKeyIndex>,
                                              BOOST_MULTI_INDEX_MEMBER(TransferUnlockJob,
   ...
   private:
    ...
    static bool isIncluded(const TransactionOutputInformationEx& output, uint32_t state,
                           uint32_t flags);
    ...
    std::vector<TransactionOutputInformation> getUnlockingTransfers(uint32_t prevHeight,
    ...
    TransactionOutputInformation getAvailableOutput(
        const TransactionOutputKey& transactionOutputKey) const;

    void copyToSpent(const TransactionBlockInfo& block, const ITransactionReader& tx,
                     size_t inputIndex, const TransactionOutputInformationEx& output);

    void rebuildTransfersUnlockJobs(TransfersUnlockMultiIndex& transfersUnlockJobs,
