...
namespace CryptoNote
{
        ...
        public INodeObserver
  {
   public:
    ...
    virtual std::vector<Crypto::Hash> getConsumerKnownBlocks(
        IBlockchainConsumer& consumer) const override;
   ...
   private:
    ...
    /// second parameter is used only in case of errors returned into callback from INode, such as
    ...
    std::list<std::pair<const ITransactionReader*, std::promise<std::error_code>>>
