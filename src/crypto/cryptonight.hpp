...
namespace Crypto
{
  ...
  inline void aes_genkey(const __m128i* memory, __m128i& k0, __m128i& k1, __m128i& k2, __m128i& k3,
                         __m128i& k4, __m128i& k5, __m128i& k6, __m128i& k7, __m128i& k8,
                         __m128i& k9)
  {
  ...
  inline void xor_shift(__m128i& x0, __m128i& x1, __m128i& x2, __m128i& x3, __m128i& x4,
  ...
  void cryptonight_hash(const void* input, size_t len, void* output, cn_context& ctx0)
  {
    ...
    cn_explode_scratchpad<SOFT_AES, MEMORY, ALGO>((__m128i*)ctx0.hash_state,
    ...
    // Optim - 90% time boundary
    cn_implode_scratchpad<SOFT_AES, MEMORY, ALGO>((__m128i*)ctx0.long_state,
    ...
    {
      case 0: blake256_hash(ctx0.hash_state, (uint8_t*)output); break;
      case 1: groestl_hash(ctx0.hash_state, (uint8_t*)output); break;
      case 2: jh_hash(ctx0.hash_state, (uint8_t*)output); break;
      case 3: skein_hash(ctx0.hash_state, (uint8_t*)output); break;
    }
  }
