...
namespace CryptoNote
{
  class JsonRpcServer : HttpServer
  {
   public:
    ...
    void start(const std::string& bindAddress, uint16_t bindPort, const std::string& user = "",
   ...
   protected:
    ...
    static void makeGenericErrorReponse(Common::JsonValue& resp, const char* what,
                                        int errorCode = -32001);
