...
namespace CryptoNote
{
  ...
  void JsonRpcServer::makeGenericErrorReponse(Common::JsonValue& resp, const char* what,
                                              int errorCode)
  {
    using Common::JsonValue;
  ...
  void JsonRpcServer::makeMethodNotFoundResponse(Common::JsonValue& resp)
  {
    ...
    code = static_cast<int64_t>(
        -32601);  // ambigous declaration of JsonValue::operator= (between int and JsonValue)
  ...
  void JsonRpcServer::makeJsonParsingErrorResponse(Common::JsonValue& resp)
  {
    ...
    JsonValue code;
    code = static_cast<int64_t>(
        -32700);  // ambigous declaration of JsonValue::operator= (between int and JsonValue)
