...
//CryptoNote::CurrencyBuilder(logger).generateGenesisTransaction(); 	  CryptoNote::BinaryArray txb =
//CryptoNote::toBinaryArray(tx); 	  std::string tx_hex = Common::toHex(txb);
...
//   } else {
//	CryptoNote::Transaction tx =
//CryptoNote::CurrencyBuilder(logger).generateGenesisTransaction(targets); 	CryptoNote::BinaryArray
