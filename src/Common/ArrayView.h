...
namespace Common
{
  ...
  class ArrayView
  {
   public:
    ...
    // The behavior is undefined unless 'arrayData' != 'nullptr' || 'arraySize' == 0. Input state
    ...
    // The behavior is undefined unless 'other' 'ArrayView' is in defined state, that is 'data' !=
    // 'nullptr' || 'size' == 0
    ...
    // The behavior is undefined unless 'ArrayView' was initialized and 'startIndex' <= 'size' and
