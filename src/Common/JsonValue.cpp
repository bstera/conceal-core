...
namespace Common
{
  ...
  JsonValue::JsonValue(const JsonValue& other)
  {
    switch (other.type)
    {
      case ARRAY: new (valueArray) Array(*reinterpret_cast<const Array*>(other.valueArray)); break;
      case BOOL: valueBool = other.valueBool; break;
      case INTEGER: valueInteger = other.valueInteger; break;
      case NIL: break;
      case OBJECT:
        new (valueObject) Object(*reinterpret_cast<const Object*>(other.valueObject));
        break;
      case REAL: valueReal = other.valueReal; break;
      case STRING:
  ...
  JsonValue::JsonValue(Type valueType)
  {
    switch (valueType)
    {
      case ARRAY: new (valueArray) Array; break;
      case NIL: break;
      case OBJECT: new (valueObject) Object; break;
      case STRING: new (valueString) String; break;
      default: throw std::runtime_error("Invalid JsonValue type for constructor");
    }
  ...
  size_t JsonValue::size() const
  {
    switch (type)
    {
      case ARRAY: return reinterpret_cast<const Array*>(valueArray)->size();
      case OBJECT: return reinterpret_cast<const Object*>(valueObject)->size();
      default: throw std::runtime_error("JsonValue type is not ARRAY or OBJECT");
    }
  }
  ...
  std::ostream& operator<<(std::ostream& out, const JsonValue& jsonValue)
  {
    switch (jsonValue.type)
    {
      ...
      case JsonValue::BOOL: out << (jsonValue.valueBool ? "true" : "false"); break;
      case JsonValue::INTEGER: out << jsonValue.valueInteger; break;
      case JsonValue::NIL: out << "null"; break;
  ...
  void JsonValue::destructValue()
  {
    switch (type)
    {
      case ARRAY: reinterpret_cast<Array*>(valueArray)->~Array(); break;
      case OBJECT: reinterpret_cast<Object*>(valueObject)->~Object(); break;
      case STRING: reinterpret_cast<String*>(valueString)->~String(); break;
      default: break;
    }
  }
