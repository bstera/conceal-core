...
namespace Common
{
  ...
  class ArrayRef
  {
   public:
    ...
    // The behavior is undefined unless 'other' 'ArrayRef' is in defined state, that is 'data' !=
    // 'nullptr' || 'size' == 0
    ...
    // The behavior is undefined unless 'ArrayRef' was initialized and 'startIndex' <= 'size' and
