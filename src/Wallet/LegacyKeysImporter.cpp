...
namespace
{
  ...
  void loadKeysFromFile(const std::string& filename, const std::string& password,
                        CryptoNote::AccountBase& account)
  {
    ...
    chacha8(keys_file_data.account_data.data(), keys_file_data.account_data.size(), key,
