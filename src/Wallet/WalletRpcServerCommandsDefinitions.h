...
#define WALLET_RPC_STATUS_BUSY "BUSY"
    ...
    struct COMMAND_RPC_CREATE_INTEGRATED
    {
      ...
      struct response
      {
        ...
        void serialize(ISerializer& s) { KV_MEMBER(integrated_address) }
      };
    };
    ...
    struct COMMAND_RPC_GET_PAYMENTS
    {
      ...
      struct response
      {
        ...
        void serialize(ISerializer& s) { KV_MEMBER(payments) }
      };
    };
    ...
    struct COMMAND_RPC_GET_TRANSFERS
    {
      ...
      struct response
      {
        ...
        void serialize(ISerializer& s) { KV_MEMBER(transfers) }
      };
    };
    ...
    struct COMMAND_RPC_GET_OUTPUTS
    {
      ...
      struct response
      {
        ...
        void serialize(ISerializer& s) { KV_MEMBER(num_unlocked_outputs) }
      };
    };
    ...
    struct COMMAND_RPC_ESTIMATE_FUSION
    {
      struct request
      {
        ...
        void serialize(ISerializer& s) { KV_MEMBER(threshold) }
      };
      ...
      struct response
      {
        ...
        void serialize(ISerializer& s) { KV_MEMBER(fusion_ready_count) }
      };
    };
    ...
    struct COMMAND_RPC_GET_TX_PROOF
    {
      ...
      struct response
      {
        ...
        void serialize(ISerializer& s) { KV_MEMBER(signature); }
      };
    };
    ...
    struct COMMAND_RPC_SEND_FUSION
    {
      ...
      struct response
      {
        ...
        void serialize(ISerializer& s) { KV_MEMBER(tx_hash) }
      };
    };
  }  // namespace wallet_rpc
}  // namespace Tools
