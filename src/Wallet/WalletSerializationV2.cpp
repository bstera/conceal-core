...
namespace CryptoNote
{
  WalletSerializerV2::WalletSerializerV2(
      ITransfersObserver& transfersObserver, Crypto::PublicKey& viewPublicKey,
      ...
      WalletTransfers& transfers, WalletDeposits& deposits,
  ...
  void WalletSerializerV2::loadKeyListAndBanalces(CryptoNote::ISerializer& serializer,
                                                  bool saveCache)
  {
    size_t walletCount;
    ...
    for (size_t i = 0; i < walletCount; ++i)
    {
      ...
      else if (saveCache)
      {
        ...
        index.modify(it, [actualBalance, pendingBalance, lockedDepositBalance,
                          unlockedDepositBalance](WalletRecord& wallet) {
  ...
  void WalletSerializerV2::saveKeyListAndBanalces(CryptoNote::ISerializer& serializer,
                                                  bool saveCache)
  {
