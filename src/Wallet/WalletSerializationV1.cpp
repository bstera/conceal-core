...
namespace
{
  ...
  void addToStream(const std::string& cipher, const std::string& name,
  ...
  template<typename Object>
  void serializeEncrypted(Object& obj, const std::string& name,
  ...
  void deserializeEncrypted(Object& obj, const std::string& name,
                            CryptoNote::CryptoContext& cryptoContext, Common::IInputStream& source)
  {
...
namespace CryptoNote
{
  ...
  WalletSerializer::WalletSerializer(
      ITransfersObserver& transfersObserver, PublicKey& viewPublicKey, SecretKey& viewSecretKey,
      uint64_t& actualBalance, uint64_t& pendingBalance, WalletsContainer& walletsContainer,
      ...
      uint32_t transactionSoftLockTime, UncommitedTransactions& uncommitedTransactions)
  ...
  void WalletSerializer::save(const std::string& password, Common::IOutputStream& destination,
                              bool saveDetails, bool saveCache)
  {
  ...
  void WalletSerializer::savePublicKey(Common::IOutputStream& destination,
  ...
  void WalletSerializer::saveSecretKey(Common::IOutputStream& destination,
                                       CryptoContext& cryptoContext)
  {
  ...
  void WalletSerializer::saveFlags(bool saveDetails, bool saveCache,
                                   Common::IOutputStream& destination, CryptoContext& cryptoContext)
  {
  ...
  void WalletSerializer::saveWallets(Common::IOutputStream& destination, bool saveCache,
                                     CryptoContext& cryptoContext)
  {
  ...
  void WalletSerializer::saveBalances(Common::IOutputStream& destination, bool saveCache,
                                      CryptoContext& cryptoContext)
  {
  ...
  void WalletSerializer::saveTransfersSynchronizer(Common::IOutputStream& destination,
                                                   CryptoContext& cryptoContext)
  {
    std::stringstream stream;
  ...
  void WalletSerializer::saveUnlockTransactionsJobs(Common::IOutputStream& destination,
                                                    CryptoContext& cryptoContext)
  {
    ...
    for (const auto& j : index)
    {
      ...
      uint64_t walletIndex =
          std::distance(m_walletsContainer.get<RandomAccessIndex>().begin(), rndIt);
  ...
  void WalletSerializer::saveUncommitedTransactions(Common::IOutputStream& destination,
                                                    CryptoContext& cryptoContext)
  {
    serializeEncrypted(uncommitedTransactions, "uncommited_transactions", cryptoContext,
                       destination);
  }

  void WalletSerializer::saveTransactions(Common::IOutputStream& destination,
                                          CryptoContext& cryptoContext)
  {
  ...
  void WalletSerializer::saveTransfers(Common::IOutputStream& destination,
                                       CryptoContext& cryptoContext)
  {
  ...
  void WalletSerializer::loadWallet(Common::IInputStream& source, const Crypto::chacha8_key& key,
                                    uint32_t version)
  {
    CryptoNote::CryptoContext cryptoContext;
  ...
  void WalletSerializer::checkKeys() { throwIfKeysMissmatch(m_viewSecretKey, m_viewPublicKey); }

  void WalletSerializer::loadFlags(bool& details, bool& cache, Common::IInputStream& source,
                                   CryptoContext& cryptoContext)
  {
  ...
  void WalletSerializer::loadTransfersSynchronizer(Common::IInputStream& source,
                                                   CryptoContext& cryptoContext)
  {
  ...
  void WalletSerializer::loadObsoleteSpentOutputs(Common::IInputStream& source,
                                                  CryptoContext& cryptoContext)
  {
    uint64_t count = 0;
  ...
  void WalletSerializer::loadUnlockTransactionsJobs(Common::IInputStream& source,
                                                    CryptoContext& cryptoContext)
  {
    auto& index = m_unlockTransactions.get<TransactionHashIndex>();
  ...
  void WalletSerializer::loadObsoleteChange(Common::IInputStream& source,
                                            CryptoContext& cryptoContext)
  {
    uint64_t count = 0;
  ...
  void WalletSerializer::loadUncommitedTransactions(Common::IInputStream& source,
                                                    CryptoContext& cryptoContext)
  {
  ...
  void WalletSerializer::initTransactionPool()
  {
    ...
    std::transform(
        uncommitedTransactions.begin(), uncommitedTransactions.end(),
  ...
  void WalletSerializer::updateTransactionsBaseStatus()
  {
    ...
    for (; begin != end; ++begin)
    {
      transactions.modify(begin, [this](WalletTransaction& tx) {
        ...
        auto it =
            std::find_if(std::begin(wallets), std::end(wallets), [&](const WalletRecord& rec) {
  ...
  void WalletSerializer::loadTransactions(Common::IInputStream& source,
                                          CryptoContext& cryptoContext)
  {
    uint64_t count = 0;
  ...
  void WalletSerializer::addWalletV1Details(const std::vector<WalletLegacyTransaction>& txs,
