      ...
      boost::multi_index::indexed_by<
          ...
          boost::multi_index::hashed_unique<boost::multi_index::tag<KeysIndex>,
                                            BOOST_MULTI_INDEX_MEMBER(
                                                WalletRecord, Crypto::PublicKey, spendPublicKey)>,
          boost::multi_index::hashed_unique<boost::multi_index::tag<TransfersContainerIndex>,
                                            BOOST_MULTI_INDEX_MEMBER(
                                                WalletRecord, CryptoNote::ITransfersContainer *,
                                                container)>>>
      WalletsContainer;
  ...
  typedef boost::multi_index_container<
      ...
      boost::multi_index::indexed_by<
          ...
          boost::multi_index::hashed_unique<
              ...
              boost::multi_index::member<CryptoNote::Deposit, Crypto::Hash,
                                         &CryptoNote::Deposit::transactionHash>>,
          boost::multi_index::ordered_non_unique<
              boost::multi_index::tag<BlockHeightIndex>,
              boost::multi_index::member<CryptoNote::Deposit, uint64_t,
                                         &CryptoNote::Deposit::height>>>>
      WalletDeposits;
