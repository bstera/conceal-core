...
namespace CryptoNote
{
  ...
  TransactionPrefixImpl::TransactionPrefixImpl(const TransactionPrefix& prefix,
  ...
  {
    input =
        boost::get<KeyInput>(getInputChecked(m_txPrefix, index, TransactionTypes::InputType::Key));
  }
  ...
  void TransactionPrefixImpl::getOutput(size_t index, MultisignatureOutput& output,
                                        uint64_t& amount) const
  {
    const auto& out =
        getOutputChecked(m_txPrefix, index, TransactionTypes::OutputType::Multisignature);
  ...
  bool TransactionPrefixImpl::findOutputsToAccount(const AccountPublicAddress& addr,
  ...
  bool TransactionPrefixImpl::getTransactionSecretKey(SecretKey& key) const { return false; }
