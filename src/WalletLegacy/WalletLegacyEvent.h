...
namespace CryptoNote
{
  ...
  class WalletTransactionUpdatedEvent : public WalletLegacyEvent
  {
   public:
    ...
    virtual void notify(
        Tools::ObserverManager<CryptoNote::IWalletLegacyObserver>& observer) override
    {
  ...
  {
   public:
    WalletDepositsUpdatedEvent(std::vector<DepositId>&& depositIds)
        : updatedDeposits(depositIds) { }
