...
namespace CryptoNote
{
  ...
  WalletUnconfirmedTransactions::WalletUnconfirmedTransactions(
      uint64_t uncofirmedTransactionsLiveTime)
  ...
  {
    return findUnconfirmedTransactionId(hash, id) ||
           findUnconfirmedDepositSpendingTransactionId(hash, id);
  }

  bool WalletUnconfirmedTransactions::findUnconfirmedTransactionId(const Crypto::Hash& hash,
                                                                   TransactionId& id)
  {
  ...
  bool WalletUnconfirmedTransactions::findUnconfirmedDepositSpendingTransactionId(
      const Crypto::Hash& hash, TransactionId& id)
  {
  ...
  void WalletUnconfirmedTransactions::add(
      const Transaction& tx, TransactionId transactionId, uint64_t amount,
  ...
  void WalletUnconfirmedTransactions::addDepositSpendingTransaction(
  ...
  void WalletUnconfirmedTransactions::deleteUsedOutputs(
      const std::vector<TransactionOutputId>& usedOutputs)
  {
