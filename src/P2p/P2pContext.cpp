...
namespace CryptoNote
{
  ...
  void P2pContext::writeMessage(const Message& msg)
  {
    ...
    {
      case P2pContext::Message::NOTIFY: proto.sendMessage(msg.type, msg.data, false); break;
      case P2pContext::Message::REQUEST: proto.sendMessage(msg.type, msg.data, true); break;
      case P2pContext::Message::REPLY: proto.sendReply(msg.type, msg.data, msg.returnCode); break;
    }
  }
  ...
  void P2pContext::timedSyncLoop()
  {
    ...
    P2pContext::Message timedSyncMessage{
      P2pMessage{ COMMAND_TIMED_SYNC::ID,
